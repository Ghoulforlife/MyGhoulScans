...
// Every feed pulls from all of these at once (no source picker anywhere).
// Kept to the big aggregators: fanning all 60+ sources per row would crawl.
const MAJOR_SOURCES = ['mangaread', 'flamecomics', 'bato', 'mangapark', 'likemanga', 'manhuaus'];
